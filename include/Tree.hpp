...
class binary_search_tree
{
    ...
    public:
        ...
        binary_search_tree(tree_node<T> root)
        {
        ...
        // Since level-wise search is done, the asymptotic complexity is O(h), here h is height of the tree.
        ...
        // Return the node with the desired key or NULL value if the node is not found.
        ...
        bool insert(const tree_node<T> &node)
        {
            ...
            tree_node<T>* in_node = new tree_node<T>(node);  // TODO: Check if there's a better way to do it.
        ...
        std::string pre_order_traversal(){
            return this -> pre_order_traversal(this -> root_node);
        }

        std::string post_order_traversal(){
